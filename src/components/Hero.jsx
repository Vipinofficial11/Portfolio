  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      ...
      items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}> Hi, I'm <span className='text-[#915eff]'> Vipin </span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop web Applications < br className='sm:block hidden' />using MERN Stack.
          </p>
        </div>
      </div>
